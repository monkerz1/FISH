...
const stores = [
  {
    name: 'Reef Dreams Aquarium',
    city: 'Miami',
    state: 'FL',
    specialties: ['Saltwater', 'Corals'],
    rating: 4.8,
  },
  {
    name: 'The Fish Tank',
  ...
  },
  {
    ...
    city: 'Seattle',
    state: 'WA',
    specialties: ['Rare Species', 'Specialty'],
    rating: 4.7,
  },
];
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {stores.map((store, index) => (
            <Card key={index} className="flex flex-col gap-4 bg-white p-6 transition-all hover:shadow-lg">
              <div>
